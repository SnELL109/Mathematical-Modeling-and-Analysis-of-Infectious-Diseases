...
parameters <- c(Lambda = 0.00817, mu = 0.00747, mud = 0.0909, WLH = 0.06, WHL = 0.04, WOR = 0, 
                sigmaO1 = 0.023, sigma12 = 8.67, sigma23 = 0.05, PL = 0, PH = 0, phiL = 0.05, phiH = 1/24, tauR = 0, phiR = 0.005,
...
matplot(times, out, type = "l", xlab = "Time (years)", ylab = "Compartments", main = "HIV Transmission Model (no PEP or PrEP)", lwd = 1, lty = 1, bty = "l", col = 2:8)
