...
sir <- function(time, state, parameters) {
  with(as.list(c(state, parameters)), {
    ...
    dSH <- WLH * SL + phiH * PO + phiR * PR - (lambdaH + WHL + tauR + mu) * SH
...
init <- c(SL = 0.95, SH = 0.047, PO = 0, PR = 0, I1 = 0.0002, I2 = 0.0017, I3 = 0.0011)
parameters <- c(Lambda = 0.00817, mu = 0.00747, mud = 0.0909, WLH = 0.005, WHL = 0.0095, WOR = 0.001, 
                sigmaO1 = 0.023, sigma12 = 8.67, sigma23 = 0.05, PL = 0.5, PH = 0.5, phiL = 0.05, phiH = 1/24, tauR = 0.9, phiR = 0.005,
